...
const ed=document.querySelector("iframe"),eh=new Vimeo.Player(ed),ep="videoplayer-current-time";eh.on("timeupdate",B(function({seconds:e}){JSON.stringify(e),localStorage.setItem(ep,e)},1e3)),eh.setCurrentTime(JSON.parse(localStorage.getItem(ep)));//# sourceMappingURL=02-video.33eae763.js.map

//# sourceMappingURL=02-video.33eae763.js.map
